...
import './FindAreasBetweenPoints.css'
import $ from 'jquery';
import {
    GoogleMap,
    InfoWindow,
...
const FindAreasBetweenPoints = ({ zoom }) => {
    // var apiKey = 'AIzaSyD-44axdMsx-kgh0CQD2HMcnlzg6S1xTjw';
    // var map;
    // var drawingManager;
    // var placeIdArray = [];
    // var polylines = [];
...
export default FindAreasBetweenPoints